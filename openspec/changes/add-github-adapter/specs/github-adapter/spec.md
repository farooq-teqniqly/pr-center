...
The `IGitHubFacts` port and its GraphQL implementation in `PrCenter.GitHub`.
Grounded in the [2026-07-10 spike](../../../../docs/spikes/2026-07-10-github-adapter-spike.md);
all mapping rules below were verified against live payloads.
