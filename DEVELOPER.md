# pr-center: developer guide

Developer setup, conventions, and contribution workflow for PR-Center. For what
the app does and how to install/use it, see the [top-level README](README.md)
and the [User Guide](USER_GUIDE.md). See [`docs/pr-center-idea.md`](docs/pr-center-idea.md)
